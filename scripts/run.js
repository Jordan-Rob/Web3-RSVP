...
const main = async () => {
    ...
    // get test wallets to use against deployed smart contract
    ...
    //////// Create new RSVPs ////////
    // RSVP created with deployer wallet address
    txn = await rsvpContract.createNewRSVP(eventID, { value: deposit });
    wait = await txn.wait();
    console.log("NEW RSVP:", wait.events[0].event, wait.events[0].args);

    //RSVP created with different wallet address1
    ...
    //Confirm all attendees that have RSVP'd
